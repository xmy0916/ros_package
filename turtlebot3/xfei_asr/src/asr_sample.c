...
{	
	int			ret						=	MSP_SUCCESS;
	const char* login_params			=	"appid = 5e608f55, work_dir = ."; //登录参数,appid与msc库绑定,请勿随意改动
	/*
	* sub:             请求业务类型
	* result_type:     识别结果格式
	...
	*/
	...
	printf("上传语法成功\n");
 	...
 	run_asr("/home/xmy/wanderbot_ws/src/xfei_asr/src/wav/iflytek01.wav",session_begin_params, grammar_id); //iflytek01对应的音频内容：“18012345678”
